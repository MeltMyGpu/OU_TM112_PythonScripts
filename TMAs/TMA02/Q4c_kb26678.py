...
def calculate_painting_pricing_estimation(surface, price_per_gallon):
    ''' 
    Calculates the estimated cost of a painting job using internal CONST values.
        ...
        OUTPUT: estimated_cost -> (non-zero, non-negative, float, rounded to 2 decimal places) The estimated cost of the painting job.
    '''
    # Init const values
    METER_PER_GALL = 60
    HOUR_PER_GALL = 5
